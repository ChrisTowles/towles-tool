...
export default class Config extends BaseCommand {
  ...
  async run(): Promise<void> {
    ...
    consola.log(`  Daily Path Template: ${this.settings.settingsFile.settings.journalSettings.dailyPathTemplate}`)
    consola.log(`  Meeting Path Template: ${this.settings.settingsFile.settings.journalSettings.meetingPathTemplate}`)
    consola.log(`  Note Path Template: ${this.settings.settingsFile.settings.journalSettings.notePathTemplate}`)
