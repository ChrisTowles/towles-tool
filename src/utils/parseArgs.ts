...
interface EatArgs {
  // Eat command has no specific args for now
}
...
export async function parseArguments(argv: string[]): Promise<ParsedArgs> {
  ...
  parser.command(
    'eat',
    'Display a cute puppy picture and tell five jokes to brighten your day',
    {},
    () => {
      parsedResult = { command: 'eat', args: {} }
    }
  )
