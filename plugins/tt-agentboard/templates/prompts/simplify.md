...
The completed summary is in `.auto-claude/issue-{issue}/completed-summary.md`.
...
Commit simplifications as `refactor(scope): code-simplify review for issue #{issue}`.

## Output

Write `.auto-claude/issue-{issue}/simplify-summary.md` with:
