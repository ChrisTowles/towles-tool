...
You are creating an implementation plan as ralph tasks using `towles-tool` CLI.
...
**Task descriptions should read like a half-page GitHub issue** - detailed enough that Claude Code can execute autonomously without asking questions.
